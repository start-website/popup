            ...
            <div class="field">
                ...
                <div class="value">
                    <div class="value-item db-inline">
                        <label>
                            <input min="0" type="number" class="input-small" v-model="block['style'][main.device]['margin_top']">
                        </label>
                        <div class="hint">{{ $t('Top') }}</div>
                    </div>
                    <div class="value-item db-inline">
                        <label>
                            <input min="0" type="number" class="input-small" v-model="block['style'][main.device]['margin_bottom']">
                        </label>
...
<script>
    ...
    import templateHtml from './templates/hr/Html.vue'
    import templateStyle from './templates/hr/Style.vue'
