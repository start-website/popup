...
<template>
    <div class="card" ref="card">
        <div class="card__preview">
            ...
            <div class="card__preview-block">
                <div class="card__preview-item">
                <a href="javascript:void(0);" class="card-button button-open-popup" v-on:click.prevent="openPopup"><i class="fa fa-cog"></i><b class="icon-margin"><i>{{ $t('Settings') }}</i></b></a>
                </div>
                <hr>
                <div class="card__preview-item">
                    <a href="javascript:void(0);" class="card-button button-copy-popup" v-on:click.prevent="copyPopup(index_group)">
                        <i class="fa fa-plus"></i><b class="icon-margin"><i>{{ $t('Copy') }}</i></b>
                    </a>
                </div>
                <div class="card__preview-item">
                    <a href="javascript:void(0);" class="card-button button-delele-popup" v-on:click.prevent="delPopup(index_group)">
                        <i class="fa fa-minus-circle"></i><b class="icon-margin"><i>{{ $t('Delete') }}</i></b>
                    </a>
                </div>
            </div>
        </div>
