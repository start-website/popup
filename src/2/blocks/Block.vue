        ...
        <div class="popup-block" :data-component="block.component" v-for="block, index_block in blocks" :key="block.id">
            <div class="popup-block__content" :data-content-block-id="block.id" :ref="'content-block-' + block.id">
                <div class="popup-block__preview active">
                    <a class="popup-block__sort" style="display:inline" href="javascript:void(0);"><i class="fa fa-bars"></i></a>
                    ...
                    <div class="preview-buttons">
                        <a class="preview-buttons__button preview-buttons__button_open" href="javascript:void(0);" :data-button-open-block-id="block.id" v-on:click.prevent="openBlock(block, index_block)"><i class="fa fa-edit"></i><b class="icon-margin"><i>{{ $t('Edit') }}</i></b></a>
                        ...
                        <a class="preview-buttons__button" href="javascript:void(0);" v-on:click.prevent="delBlock([index_group, block.id])" style="margin-left: 8px;"><i class="fa fa-minus-circle"></i><b class="icon-margin"><i>{{ $t('Delete') }}</i></b></a>
                    </div>
                </div>
