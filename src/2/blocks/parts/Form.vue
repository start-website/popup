    ...
    <div class="popup-block__inner">
        ...
        <div class="block-fields">
            <div class="field">
                ...
                <div class="value">
                    <label>
                        <select v-model="block['params']['email']['action']">
                            <option value="" disabled>{{ $t('Choose one of the options') }}</option>
        ...
        <div class="block-fields">
                    ...
                    <div class="component-form__field-preview">
                        ...
                        <div class="component-form__field-preview-item">
                            <div class="preview-buttons">
                                <a class="preview-buttons__button preview-buttons__button_open" href="javascript:void(0);" v-on:click.prevent="openComponentFormField(item)"><i class="fa fa-edit"></i><b><i>{{ $t('Edit') }}</i></b></a>
                                <a class="preview-buttons__button preview-buttons__button_close" href="javascript:void(0);" v-on:click.prevent="closeComponentFormField(item)"><b><i style="margin-left: 3px;">{{ $t('Cancel') }}</i></b></a>
                                <a class="preview-buttons__button" href="javascript:void(0);" style="margin-left: 8px;" v-on:click.prevent="delFormField(index)"><i class="fa fa-minus-circle"></i><b><i style="margin-left: 3px;">{{ $t('Delete') }}</i></b></a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div v-if="item && item['type'] && item['type'].match(/select|checkbox|radio/)" class="component-form__field-input-wrap">
                                ...
                                <div class="component-form__options">
                                    <div v-for="(option, index_option) in item['options']" class="component-form__option" :key="index_option">
                                        ...
                                        <a class="component-form__button-del-option" href="#" v-on:click.prevent="delFormFieldOption(item['options'], index_option)"><i class="fa fa-minus-circle"></i>{{ $t('Delete option') }}</a>
                                    </div>
                                </div>
                                <a class="component-form__button-add-option" href="#" v-on:click.prevent="addFormFieldOption(item['options'])"><i class="fa fa-plus-circle"></i>{{ $t('Add option') }}</a>
                            </div>
            ...
            <div class="component-form__item-add-wrap">
                ...
                <div class="component-form__item-add">
                    ...
                    <a href="#" v-on:click.prevent="addFormField"><i class="fa fa-plus-circle"></i>{{ $t('Add') }}</a>
                </div>
            </div>
        </div>
