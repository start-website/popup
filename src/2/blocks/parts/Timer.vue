...
<template>
    <div  class="popup-block__inner">
        ...
        <div class="block-fields">
            <div class="field">
                <div class="name">{{ $t('Date') }}</div>
                <div class="value">
                    <label>
                        <input type="date" v-model="block['timer_date']">
                    </label>
                    <label>
                        <input type="time" v-model="block['timer_time']">
                    </label>
                </div>
            </div>
        </div>
        ...
        <div class="block-fields">
            <div class="field">
				...
				<div class="value">
					<label>
						<input type="number" min="0" v-model="block['style'][main.device]['font_size']" required>
					</label>
				</div>
			</div>
            ...
            <div class="field">
                ...
                <div class="value">
                    <label>
                        <input type="text" v-model="block['style'][main.device]['background']" placeholder="transparent">
                    </label>
            ...
            <div class="field">
                ...
                <div class="value">
                    <label>
                        <input type="text" v-model="block['style'][main.device]['color']" required>
                    </label>
...
<script>
    ...
    import templateHtml from './templates/timer/Html.vue'
    import templateStyle from './templates/timer/Style.vue'
